        ...
        extends SqlOperator
{
    ...
    protected List<MethodHandle> getMethodHandles(RowType type, FunctionManager functionManager, OperatorType operatorType)
    {
        ...
        for (Type parameterType : type.getTypeParameters()) {
            FunctionHandle handle = functionManager.resolveOperator(operatorType, ImmutableList.of(parameterType, parameterType));
            argumentMethods.add(functionManager.getScalarFunctionImplementation(handle).getMethodHandle());
        }
